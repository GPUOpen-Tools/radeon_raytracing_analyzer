...
git_mapping = {
    ...
    github_root  + "g-truc/glm"                                     : ["../external/glm",              "0.9.9.8"],
    github_root  + "KhronosGroup/Vulkan-Headers"                    : ["../external/vulkan",           "sdk-1.3.211"],
    github_root  + "zeux/volk"                                      : ["../external/volk",             "1.2.190"],
    github_root  + "GPUOpen-LibrariesAndSDKs/VulkanMemoryAllocator" : ["../external/vma",              "d2f0313d20c803f83cc3637ac1facf8e4d6899e4"],
    github_root  + "GPUOpen-Drivers/libamdrdf"                      : ["../external/rdf",              "8e6d70779fb4f86cfa48acc895d5008f87522f30"],
}
