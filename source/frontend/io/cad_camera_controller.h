...
/// @file
/// @brief  Declaration for the CAD style camera controller.
//=============================================================================
...
namespace rra
{
    class CADController : public ViewerIO
    {
    public:
        /// @brief Constructor.
        CADController();
    ...
    private:
        float last_camera_movement_speed_ = 1.0f;  ///< The last camera movement speed.
    };
}  // namespace rra
