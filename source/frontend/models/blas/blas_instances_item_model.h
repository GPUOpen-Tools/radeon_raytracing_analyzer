...
/// @file
/// @brief  Definition for the BLAS instances item model.
//=============================================================================

#ifndef RRA_MODELS_BLAS_BLAS_INSTANCES_ITEM_MODEL_H_
#define RRA_MODELS_BLAS_BLAS_INSTANCES_ITEM_MODEL_H_
...
namespace rra
{
    ...
    struct BlasInstancesStatistics
    {
    ...
    enum BlasInstancesColumn
    {
        ...
        kBlasInstancesColumnInstanceIndex,

        kBlasInstancesColumnCount,
    };

    /// @brief A class to handle the model data associated with BLAS list table.
    class BlasInstancesItemModel : public QAbstractItemModel
    {
    public:
        /// @brief Constructor.
        ///
        /// @param [in] parent The parent widget.
        explicit BlasInstancesItemModel(QObject* parent = nullptr);

        /// @brief Destructor.
        virtual ~BlasInstancesItemModel();
        ...
        void AddAccelerationStructure(const BlasInstancesStatistics& stats);
    ...
    private:
        ...
        std::vector<BlasInstancesStatistics> cache_;        ///< Cached data from the backend.
    };
}  // namespace rra

#endif  // RRA_MODELS_BLAS_BLAS_INSTANCES_ITEM_MODEL_H_
