...
#ifndef RRA_MODELS_RAY_RAY_INSPECTOR_SCENE_COLLECTION_MODEL_H_
#define RRA_MODELS_RAY_RAY_INSPECTOR_SCENE_COLLECTION_MODEL_H_
...
namespace rra
{
    ...
    class RayInspectorSceneCollectionModel : public SceneCollectionModel
    {
    public:
        /// @brief Constructor.
        RayInspectorSceneCollectionModel() = default;

        /// @brief Destructor.
        virtual ~RayInspectorSceneCollectionModel();
