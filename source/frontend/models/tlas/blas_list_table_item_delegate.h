...
/// @file
/// @brief Definition of RRA's blas list table item delegate.
//=============================================================================

#ifndef RRA_MODELS_BLAS_LIST_TABLE_ITEM_DELEGATE_H_
#define RRA_MODELS_BLAS_LIST_TABLE_ITEM_DELEGATE_H_

#include "models/table_item_delegate.h"

class BlasListTableItemDelegate : public TableItemDelegate
{
    Q_OBJECT
public:
    /// @brief Constructor.
    ...
    BlasListTableItemDelegate(QObject* parent = 0);

    /// @brief Destructor.
    virtual ~BlasListTableItemDelegate();
