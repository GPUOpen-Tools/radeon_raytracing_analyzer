...
#ifndef RRA_VIEWS_CUSTOM_WIDGETS_BINARY_CHECKBOX_H_
#define RRA_VIEWS_CUSTOM_WIDGETS_BINARY_CHECKBOX_H_

#include <QCheckBox>

/// @brief Modern-style colored checkbox that is aware of resize and mouse events.
class BinaryCheckbox : public QCheckBox
{
    Q_OBJECT
...
public:
    ...
    explicit BinaryCheckbox(QWidget* parent);

    /// @brief Destructor.
    virtual ~BinaryCheckbox();
