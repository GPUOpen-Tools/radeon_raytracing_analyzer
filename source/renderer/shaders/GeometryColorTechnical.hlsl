...
/// @file
/// @brief  Shader for coloring by technical drawing.
//=============================================================================
    ...
    : SV_TARGET
{
    ...
    float4 colA                = abs(float4(0.0f, 1.0f, 0.0f, 1.0f));
    float4 colB                = abs(float4(0.0f, 0.0f, 1.0f, 1.0f));
    float4 coloring_mode_color = lerp(colA, colB, dot(normal, light)) + float4(0.2f, 0.2f, 0.2f, 0.0f);
