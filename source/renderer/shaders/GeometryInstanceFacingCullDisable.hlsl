...
/// @file
/// @brief  Shader for coloring by instance face culling disabled.
//=============================================================================
...
#define GEOMETRY_INSTANCE_TRIANGLE_FACING_CULL_DISABLE_BIT 0x1
...
PSInput VSMain(VSInput input, uint vertexId : SV_VertexID)
{
    ...
    if (input.flags & GEOMETRY_INSTANCE_TRIANGLE_FACING_CULL_DISABLE_BIT)
    {
