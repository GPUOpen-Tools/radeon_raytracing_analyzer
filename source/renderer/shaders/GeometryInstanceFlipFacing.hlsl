...
/// @file
/// @brief  Shader for coloring by instance flip facing.
//=============================================================================
...
#define GEOMETRY_INSTANCE_TRIANGLE_FLIP_FACING_BIT 0x2
...
PSInput VSMain(VSInput input, uint vertexId : SV_VertexID)
{
    ...
    if (input.flags & GEOMETRY_INSTANCE_TRIANGLE_FLIP_FACING_BIT)
    {
