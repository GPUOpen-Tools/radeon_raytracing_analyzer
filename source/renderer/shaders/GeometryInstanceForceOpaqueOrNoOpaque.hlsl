...
/// @file
/// @brief  Shader for coloring by opaque/non-opaque.
//=============================================================================
...
struct VSInput
{
    ...
    [[vk::location(5)]] uint   flags : METADATA0;
...
PSInput VSMain(VSInput input, uint vertexId : SV_VertexID)
{
    ...
    uint mask = GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT | GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT;
    if ((input.flags & mask) == mask)
    {
        result.color = scene_ubo.instance_opaque_force_both_color;
    }
    else if (input.flags & GEOMETRY_INSTANCE_FORCE_OPAQUE_BIT)
    {
        result.color = scene_ubo.instance_opaque_force_opaque_color;
    }
    else if (input.flags & GEOMETRY_INSTANCE_FORCE_NO_OPAQUE_BIT)
    {
        result.color = scene_ubo.instance_opaque_force_no_opaque_color;
    }
